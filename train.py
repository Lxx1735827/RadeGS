...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[1500, 3000, 4500, 6000, 7500, 9000, 10000, 13000, 16000, 19000, 21000, 25000, 30000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1500, 3000, 4500, 6000, 7500, 9000, 10000, 13000, 16000, 19000, 21000, 25000, 30000])
