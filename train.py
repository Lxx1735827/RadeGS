    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        while network_gui.conn != None:
            try:
                ...
                if custom_cam != None:
                    net_image = render(custom_cam, gaussians, pipe, background, kernel_size, True, 0.1, scaling_modifer)["render"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[1500, 3000, 4500, 6000, 7500, 9000, 10000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1500, 3000, 4500, 6000, 7500, 9000, 10000])
