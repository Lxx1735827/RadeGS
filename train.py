...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[1500, 2000, 3000, 3500, 5000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1500, 2000, 3000, 3500, 5000])
